      ...
      >
        <ul className="flex flex-col gap-5 border-y border-light-gray py-5 my-2">
          ...
          <li className="flex justify-start items-center gap-3">
            <div className="flex items-center justify-center w-[30px] h-[30px] bg-light-gray rounded-md shadow-md shadow-white/10">
              <Image
                src={"/Portfolio/icon/smartphone.png"}
                alt="smartphone"
                width={16}
                height={16}
              />
          ...
          <li className="flex justify-start items-center gap-3">
            <div className="flex items-center justify-center w-[30px] h-[30px] bg-light-gray rounded-md shadow-md shadow-white/10">
              <Image
                src={"/Portfolio/icon/location.png"}
                alt="location"
                width={16}
                height={16}
              />
        ...
        <div className="flex gap-3">
          <Image
            src={"/Portfolio/icon/linkedin.svg"}
            alt="linkedin"
            width={20}
            height={20}
          />
          <Image
            src={"/Portfolio/icon/github.svg"}
            alt="github"
            width={20}
            height={20}
          />
